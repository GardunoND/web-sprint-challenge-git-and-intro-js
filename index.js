...
function removeArtist(array, number) {
  const artistCopy = [...array];
  artistCopy.splice(artistCopy[number], 1)
  return artistCopy;
}
...
console.log(addArtist(artists, 'my name', 'my birth year - present', 'aspiring full stack developer',  'spanish and italian', 'whatever i put before'))
